...
║╭───────────
║│➸  ${prefix}creator
║│Sobre : Manda contato do criador
║╰───────────
╠════════════════════
║╭──❉ *STICKERS* ❉──
║│➸ ${prefix}figu
...
║╭───────────
║│➸${prefix}shota
║│Sobre : proibido a menores de 18 KKK
║╰───────────
║╭───────────
║│➸${prefix}neko
...
║╭───────────
║│➸ ${prefix}clone
║│Sobre : bot vai usar no perfil
║│a foto da pessoa marcado com <@>
║╰───────────
║╭───────────
║│➸ ${prefix}virtex
...
╠════════════════════
║╭──❉ *TESTES* ❉──
║│➸ ${prefix}lirik <nome da msc>
║│Sobre : manda letra da música
║╰───────────
║╭───────────
║│➸ ${prefix}antilinkgroup <1/0>
║│Sobre : Não sei se pega KKK
║│Mais caso mandem link de outro grupo
║│o bot remove
║╰───────────
║╭───────────
║│➸  ${prefix}sairgp
║│Sobre : tu sai do grupo né KKK
║╰───────────
║╭───────────
║│➸  ${prefix}wiki <text>
║│Sobre : Pesquisa oq tu quer mais sai em árabe
║╰───────────
╠════════════════════
║╭──❉ *ESSES SÓ O ঔৣ͜͡ 𝑯𝑰𝑫𝑹𝑨 PODE USAR* ❉──
║│➸  ${prefix}prefixo
...
║╰───────────
╠════════════════════
║ ঔৣ͜͡ 𝑯𝑰𝑫𝑹𝑨 𝑶  ⃬⃗𝑩͢𝑹͢𝑨𝑩𝑶͢𝑹 𝑫𝑶𝑺 𝑴𝑬𝑵𝑼
╚════════════════════
`
}
